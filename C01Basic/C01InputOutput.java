...
//        System.out.println(20); // 1) println은 줄바꿈있는 출력. 2) 입출력은 모두 문자열로 진행
...
//        System.out.println("입력사항 : " + input4);

//        입력2 : BufferedReader
//          1) 버퍼를 활용하여 더 좋은 성능을 발휘한다. 2) InputStreamReader는 바이트 대신 문자단위로 입력(큰 단위를 처리함)

//        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
//        String input2 = br.readLine(); // 입력받은 데이터를 한줄씩 read한다.
...
//        close()는 메모리 회수. 외부입출력장치와 연계된 코드이므로, GC(가비지컬렉터)의 대상이 아님.
//        br.close();
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
